...
- linux: [download v2.5.1 from pytorch.org](https://download.pytorch.org/libtorch/cpu/libtorch-shared-with-deps-2.5.1%2Bcpu.zip)
- macos arm64: [download v2.5.1 from pytorch.org](https://download.pytorch.org/libtorch/cpu/libtorch-macos-arm64-2.5.1.zip).
- macos x64: [download v2.2.2 from pytorch.org](https://download.pytorch.org/libtorch/cpu/libtorch-macos-x86_64-2.2.2.zip).
- windows: [download v2.5.1 from pytorch.org](https://download.pytorch.org/libtorch/cpu/libtorch-win-shared-with-deps-2.5.1%2Bcpu.zip)
